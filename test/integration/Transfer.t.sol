...
contract TransferTestBase is SparkLendTestBase {
...
contract TransferRoundingTests is TransferTestBase {

    function testFuzz_maxTransfer(uint256 liquidityIndex, uint256 balance) external {
        ...
        vm.prank(owner);
        aBorrowAsset.transfer(recipient, expectedSenderBalance);
